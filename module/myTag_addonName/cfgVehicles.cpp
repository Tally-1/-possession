class CfgVehicles
{
	...
	class TAG_Module_Nuke: Module_F
	{
		...
		icon = "\a3\ui_f\data\igui\cfg\simpletasks\types\destroy_ca.paa";	// Map icon. Delete this entry to use the default icon.
		category = "Effects";

		function = "myTag_fnc_moduleNuke";	// Name of function triggered once conditions are met
